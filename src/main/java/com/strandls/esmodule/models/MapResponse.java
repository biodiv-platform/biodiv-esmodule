...
public class MapResponse {
	...
	/**
	 * List of {@link MapDocument} to be sent as response to the request
	 */
	private List<MapDocument> documents;

	/**
	 * Total number of documents which satisfied the request condition. This number
	 * may be different than the size of list if limit/offset were specified in the
	 * request.
	 */
	private long totalDocuments;

	/**
	 * Geographic aggregation of the result based on geohash. Maximum buckets are
	 * 10000.
	 */
