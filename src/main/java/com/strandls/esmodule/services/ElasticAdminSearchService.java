...
public interface ElasticAdminSearchService {
	 ...
	 *
	 * @param index   the index on which mapping needs to be defined
	 ...
	 *
	 * @param index   the index on which mapping needs to be defined
	 * @param type    elastic search accepts a single type per index
	 * @param mapping the mapping
	 *
	 * @return {@link MapQueryResponse}
	 *
	 ...
	 *
	 * @param index the index for which mapping is needed
	 *
